 ...
 *
 * Fields in classes (abstract or not) that are annotated with <tt>@</tt>BuildableSubclasses may be annotated with <tt>@</tt>Fluently,
 * and when the concrete <tt>@</tt>Buildable class is processed, it will have fields fluently buildable from both its own
